...
- **활용 2편**: 실전! 스프링 부트와 JPA 활용 2편 (API 개발과 성능 최적화) — ✅ 완료
- **데이터 JPA**: 실전! 스프링 데이터 JPA — ✅ 완료
...
| 3 | 공통 인터페이스 기능 | ✅ `3. 공통 인터페이스 기능.md` |
| 4 | 쿼리 메소드 기능 | ✅ `4. 쿼리 메소드 기능.md` |
| 5 | 확장 기능 | ✅ `5. 확장 기능.md` |
| 6 | 스프링 데이터 JPA 분석 | ✅ `6. 스프링 데이터 JPA 분석.md` |
| 7 | 나머지 기능들 | ✅ `7. 나머지 기능들.md` |

### 활용 2편 — 실전! 스프링 부트와 JPA 활용 2 (API 개발과 성능 최적화) (완료)
...
| 5 | API 개발 고급 - 실무 필수 최적화 | ✅ `5. API 개발 고급 - 실무 필수 최적화.md` |
| 6 | 다음으로 | ⏭️ 스킵 (강의 마무리 안내라 정리 생략) |
