...
- **3단계**: 실전! 스프링 부트와 JPA 활용 2편 — API 개발과 성능 최적화 ✅ 완료
- **4단계**: 실전! 스프링 데이터 JPA ✅ 완료
...
| 2 | 예제 도메인 모델 | [2. 예제 도메인 모델.md](study/SpringDataJPA/docs/2.%20예제%20도메인%20모델.md) |
...
| 7 | 나머지 기능들 | [7. 나머지 기능들.md](study/SpringDataJPA/docs/7.%20나머지%20기능들.md) |
...
| 2 | API 개발 고급 - 준비 | [2. API 개발 고급 - 준비.md](study/docs/SpringBootJPA/활용2/2.%20API%20개발%20고급%20-%20준비.md) |
